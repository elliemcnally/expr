...
export var wallSound = new soundFile("ScreamWoman.wav"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("Cartoonscream1.wav");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("silence.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("Puppet Combo Murder House OST - Death Bells_[_YouConvert.net_].mp3");
